...
LEVELS: list[LevelConfig] = [
    LevelConfig(
        ...
        bg_color=(16,18,28),
        grid_color=(28,34,48),
        music='assets/music/back_music1.mp3',
        music_volume=0.5,
        wallpaper='assets/img/wallpaper1.jpg',
    ),
    LevelConfig(
    ...
    LevelConfig(
        ...
        spawn_factor=0.9,
        speed_factor=0.5,
        target_score=120,  # precisa bater 300 e derrotar o boss
        bg_color=(20,14,18),
        grid_color=(40,24,34),
        has_boss=True,
        boss_words=["RECONSTRUIR","SUSTENTABILIDADE","COLABORACAO","COMUNIDADE","GUARABYTE","FUTURO","ENERGIA","FATEC"],
        boss_health=4,
        music='assets/music/back_music1.mp3',
        music_volume=0.5,
        wallpaper='assets/img/wallpaper1.jpg',
