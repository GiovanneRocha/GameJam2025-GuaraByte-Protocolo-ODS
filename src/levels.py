...
LEVELS: list[LevelConfig] = [
    ...
    LevelConfig(
        ...
        bg_color=(18,16,24),
        grid_color=(32,28,44),
        music='assets/musics/back_music2.mp3',
        music_volume=0.5,
    ...
    LevelConfig(
        ...
        bg_color=(14,20,20),
        grid_color=(24,36,36),
        music='assets/musics/back_music3.mp3',
        music_volume=0.5,
    ...
    LevelConfig(
        ...
        words=["DESLIGAMENTO","DELETE","POLUICAO","ENERGIA","LIMPA"],
        spawn_factor=0.9,
        speed_factor=0.5,
        target_score=600,  # precisa bater 300 e derrotar o boss
        bg_color=(20,14,18),
        grid_color=(40,24,34),
        has_boss=True,
        boss_words=["RECONSTRUIR","SUSTENTABILIDADE","COLABORACAO","COMUNIDADE","GUARABYTE","VIRUS","FATEC"],
        boss_health=7,
        music='assets/musics/back_music4.mp3',
        music_volume=0.5,
